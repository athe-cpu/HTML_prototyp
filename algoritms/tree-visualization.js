...
// var tree = d3.tree().separation(40);
...
var handleRandom = function(event) {
	...
	randomTree(n, function() {
		d3.selectAll('#randomTree input').each(function() { // Enable insert
			d3.select(this).attr('disabled', null);
		});
	});
	}
